    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String insertDataSQL = "INSERT INTO cars (Model, Company, Price, Year) VALUES " +
                    "('ABC', 'Toyota', 150000, 2010), " +
                    "('DEF', 'Honda', 120000, 2015), " +
                    "('GHI', 'Ford', 180000, 2018), " +
                    "('JKL', 'Chevrolet', 200000, 2020)";
            ...
            String updatePrice = "UPDATE cars SET Price = 125000 WHERE Model='DEF'";
            statement.executeUpdate(updatePrice);
            System.out.println("\nPrice updated for Model 'DEF'.");
